...
int main(void)
{
        ...
        double media_temp, divt1, divt2, corgerad, corbat;
        ...
        for(int cont2=1;cont2<=6;cont2++)
        {
                ...
                //printf("msp retornou = %d\n \n", msp430_ret2);
                        ...
                        corbat = ((((ad3*resoluc)-1.725)*1000)/185)+0.2;
                        ...
                        corgerad=((((ad1*resoluc)-1.737)*1000)/185)+0.28;
        ...
        */
        ...
        //char c[] = "oi";
        //fputc(x,fp);
        fprintf(fp, "TEMP_REFLETOR,TEMP_PFRIO,IRRAD_LDR,IRRAD_UV,VBAT,VGER,IBAT,IGER,ROT,TEMP_PQUENTE,GPS\n");
        fprintf(fp, "%f,%f,%f,%f,%f,%f,%f,%f,%f,",media_temp,a0,G,uv_irad,divt1,divt2,corbat,corgerad);
        fclose(fp);
